...
/** End of Last Invoice Period - the day after the last invoiced service period. If service period is 2020-09-27 to
  * 2020-10-26, then end of last invoice period, or equivalently next invoice date, is 2020-10-27. Note that
  * serviceEndDate is inclusive unlike misnomer chargedThroughDate which is exclusive. The reason why we cannot always
  * rely on chargedThroughDate is because we do not perform bill run in real-time at point of acquisition.
  */
