...
object Program {
  ...
  def program(input: RefundInput): RefundOutput = {
    ...
    logger.info("Fetching invoice items")
    ...
    logger.info("Deciding relevant invoice")
    ...
    logger.info("Fetching invoice item adjustments")
    ...
    logger.info("Fetching invoice payment id")
    ...
    logger.info("Spreading refund across items")
    ...
    logger.info("Rounding adjustments")
    ...
    logger.info("Applying refund over item adjustments")
    ...
    logger.info("Getting balance after refund")
